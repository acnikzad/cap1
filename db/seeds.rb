...
user = User.new(first_name: "Billy", last_name: "Madison", email: "Billy@mad.com", password: "password", phone_number: 54434573623, home_address: "bippity bop street")
user.save

user = User.new(first_name: "Hooman", last_name: "Tall", email: "hman@tall.com", password: "password", phone_number: 54434573623, home_address: "bada bing street")
user.save

user = User.new(first_name: "Brian", last_name: "Watsonville", email: "brian@watsonville.com", password: "password", phone_number: 54434573623, home_address: "bada boom street")
user.save

alert = Alert.new(dog_id: 2, user_id: 4)
alert.save